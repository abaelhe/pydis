...
from .pubsub_packet import Packet
        ...
        while encoded_payload:
            if six.byte2int(encoded_payload[0:1]) <= 1:
                ...
                while six.byte2int(encoded_payload[i:i + 1]) != 255:
                    ...
                    i += 1
                self.packets.append(Packet(encoded_packet=encoded_payload[i + 1:i + 1 + packet_len]))
            else:
                ...
                self.packets.append(Packet(encoded_packet=pkt))
