...
from .tornado_redis import Pydis
from .pubsub_manager import PubsubManager
from .pubsub_namespace import PubsubNamespace
from .pubsub_packet import Packet, EVENT
...
class PubsubServer(object):
    ...
    """
    def __init__(self, client_manager=None, logger=False, binary=False, json=None, async_handlers=None, **kwargs):
        self.eio = Pydis(**kwargs)
        ...
        self.manager = PydisManager() if client_manager is None else client_manager
    ...
    def emit(self, event, data=None, room=None, skip_sid=None, namespace=None,
        ...
        """
        namespace = namespace or '/'
        self.logger.info('emitting event "%s" to %s [%s]', event, room or 'all', namespace)
        self.manager.emit(event, data, namespace, room, skip_sid, callback, **kwargs)
    ...
    def register_namespace(self, namespace_handler):
        ...
        :param namespace_handler: An instance of a :class:`Namespace`
                                  ...
                                  for a namespace.
        """
        if not isinstance(namespace_handler, PubSubNamespace):
    ...
    def _emit_internal(self, sid, event, data, namespace=None, id=None):
        ...
        if isinstance(data, tuple):
            ...
            data = [data]
        self._send_packet(sid, Packet(EVENT, namespace=namespace, data=[event] + data, id=id, binary=binary))
