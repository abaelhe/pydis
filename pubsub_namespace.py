...
class PubsubNamespace(object):
    ...
    def emit(self, event, data=None, room=None, skip_sid=None, namespace=None, callback=None):
        ...
        """
        return self.server.emit(event, data=data, room=room, skip_sid=skip_sid, namespace=namespace or self.namespace, callback=callback)

    def send(self, data, room=None, skip_sid=None, namespace=None, callback=None):
        ...
        associated with the class is used.
        """
        return self.server.send(data, room=room, skip_sid=skip_sid, namespace=namespace or self.namespace, callback=callback)
